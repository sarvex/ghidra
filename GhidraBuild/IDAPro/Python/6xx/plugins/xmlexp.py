...
class XmlExporter:
    ...
    def get_space_name(self, addr):
        ...
        if pid == idaapi.PLFM_TMS:
            return "CODE" if stype == idaapi.SEG_CODE else "DATA"
        return None
    ...
    def get_type(self, flags):
        ...
        return "align" if idaapi.isAlign(flags)    == True else "unknown"
    ...
    def is_imm_op(self, addr, op):
        ...
        """
        idaapi.decode_insn(addr)
        return idaapi.cmd.Operands[op].type == idaapi.o_imm
